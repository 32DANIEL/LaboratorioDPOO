...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pa�s del atleta solicitado");
	...
	{
		System.out.println("\n" + "Consultar pa�s del atleta solicitado");
		
		String atleta = input("Por favor ingrese el nombre del atleta a consultar");
		String pais = calculadora.ejecutarAtletaPais(atleta);
		
		if (pais == null)
			
		{
			System.out.println("No existe un atleta con ese nombre" + "(" + atleta + ")");
		}
		
		else
		{
			System.out.println(atleta + " es de " + pais);
		}
